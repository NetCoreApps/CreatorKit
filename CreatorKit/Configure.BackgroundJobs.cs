...
[assembly: HostingStartup(typeof(CreatorKit.ConfigureBackgroundJobs))]
...
public class ConfigureBackgroundJobs : IHostingStartup
{
    public void Configure(IWebHostBuilder builder) => builder
        .ConfigureServices((context,services) => {
            ...
            services.AddTransient<EmailMessageCommand>(c => new EmailMessageCommand(
                c.GetRequiredService<SmtpConfig>()));
            ...
            var emailSender = services.GetRequiredService<IEmailSender<AppUser>>();
